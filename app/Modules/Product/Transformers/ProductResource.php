...
//            "current_currency" => $request->header('currency') ??optional(optional(optional($this->store)->country)->currency)->code,
            ...
            'store_currency' => $this->store->country->currency->code  ?? '',
             'category' => !is_null($this->category)? new CategoryResource($this->category):"",
            ...
            'package_categories' => ! is_null($this->packageCategories)?$this->packageCategories->transform(function ($category) {
